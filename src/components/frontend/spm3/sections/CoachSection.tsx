        ...
        <div className="grid md:grid-cols-5 gap-10 lg:gap-14 items-start">
          ...
          <AnimatedSection className="md:col-span-3" delay={0.15}>
            <div className="space-y-6">
              <div>
                <p className="font-body text-gold font-semibold text-xs uppercase tracking-[0.2em] mb-3">
              ...
              <div className="flex flex-wrap gap-3 pt-4">
                {['UNICEF', 'United Nations', 'Aleto Foundation', 'BT Group'].map((org) => (
                  <span
                    key={org}
                    className="font-body text-xs uppercase tracking-wider border border-gold/30 bg-gold/5 text-gold px-4 py-2 rounded-sm font-semibold"
                  >
                    {org}
                  </span>
                ))}
