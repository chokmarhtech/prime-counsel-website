      ...
      <div className="container mx-auto max-w-6xl space-y-14">
        ...
        <AnimatedSection>
          <h2 className="font-heading text-3xl md:text-5xl lg:text-6xl text-foreground text-center mb-4">
            Is This <span className="text-gold">Right for You?</span>
          </h2>
          <p className="font-body text-muted-foreground text-center text-lg max-w-2xl mx-auto">
            ...
            structured thriving, SPM 3.0 is for you.
          </p>
        </AnimatedSection>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <AnimatedSection delay={0.1}>
            <div className="h-full rounded-2xl border border-gold/30 bg-card p-8 flex flex-col gap-6">
              {/* Card header */}
              <div className="flex items-center gap-3">
                <FiCheck className="w-5 h-5 text-gold shrink-0" />
                <h3 className="font-heading text-xl md:text-2xl text-gold font-bold">
                  This IS for you if...
                </h3>
              </div>
              ...
              <ul className="flex flex-col gap-4">
                {AUDIENCE_ITEMS.map((item, i) => (
                  <li key={i} className="flex items-start gap-3">
                    <FiCheck className="w-4 h-4 text-gold mt-1 shrink-0" />
