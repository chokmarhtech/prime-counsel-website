        ...
        <AnimatedSection delay={0.15}>
          <div className="bg-card border border-border rounded-sm shadow-xl overflow-hidden">
            <div className="bg-primary p-6 relative overflow-hidden">
              <div className="absolute inset-0 bg-gold to-transparent" />
              <p className="font-heading text-2xl md:text-3xl text-navy text-center relative">
                SPM 3.0 — Birmingham 2026
              </p>
            </div>
            ...
            <div className="px-8 pb-8 md:px-10 md:pb-10 text-center">
              <RegistrationModal>
                <button className="inline-block bg-gold text-navy font-body font-bold px-10 py-4 rounded-sm tracking-wider uppercase hover:brightness-110 transition-all duration-300 w-full sm:w-auto cursor-pointer shadow-lg hover:scale-105">
                  Register Now
                </button>
              </RegistrationModal>
            </div>
