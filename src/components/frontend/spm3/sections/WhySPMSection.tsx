      ...
      <div className="container mx-auto max-w-6xl">
        <AnimatedSection>
          ...
          <p className="font-body text-muted-foreground text-center max-w-2xl mx-auto mb-4 text-lg">
            Effort without positioning keeps you active but drained. SPM 3.0
            changes that.
          </p>
          ...
          {WHY_ITEMS.map((item, i) => {
            ...
            return (
              <AnimatedSection key={i} delay={0.1 * i}>
                <div className="bg-card border border-border rounded-sm p-8 h-full hover:border-gold/40 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
                  <div className="w-12 h-12 rounded-sm bg-gold/10 flex items-center justify-center mb-6 group-hover:bg-gold group-hover:shadow-lg transition-all duration-300">
                    <Icon className="w-6 h-6 text-gold group-hover:text-gold-foreground transition-colors duration-300" />
                  </div>
